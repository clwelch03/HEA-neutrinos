...
const AVG_NUCLEON_MASS = 938.92
const NUCLEON_MASS_SPLITTING = NEUTRON_MASS - PROTON_MASS
...
const NUCLEAR_MAGNETON = ELEM_CHARGE/(2*NEUTRON_MASS)
const NEUTRON_AMM = -1.913*ELEM_CHARGE/(2*NEUTRON_MASS)
const PROTON_AMM = 2.793*ELEM_CHARGE/(2*NEUTRON_MASS)
const NEUTRON_GYROMAGNETIC_RATIO = 3.826
const PROTON_GYROMAGNETIC_RATIO = 5.586
